  ...
  <body>
      <section id="patient-login">
        <div class='inner-section-container'>
          <form class="login-form patient" action="./include/login-patient.script.php" method="POST">
            <img class="department-logo" src="images/ai-logo.png">
          ...
          <div class='element-link orange'>Don't have an account? <a href="https://health.aiiot.website/signup/">Create Account</a></div>
        </div>
      </section>     
      <section id="doctor-login">
        <div class='inner-section-container'>
          ...
          <div class='element-link green'>Don't have an account? <a href="https://health.aiiot.website/signup/">Create Account</a></div>
        </div>
      </section>
  </body>
</html>